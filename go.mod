...
replace github.com/btcsuite/btcwallet => github.com/hsjoberg/btcwallet v1.7.4

replace github.com/btcsuite/btcwallet/walletdb => github.com/hsjoberg/btcwallet/walletdb v1.7.4
