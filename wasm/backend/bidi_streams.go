...
// Bidi-streaming RPC bridge for the browser runtime. Generated mobile bidi
// bindings return a real SendStream handle, so the JS wrapper can both send
// raw bytes and close the underlying stream.
